...
class Warden
{
    ...
    public function grantAccess($roleOrPermission, UserInterface $user = null)
    {
        ...
        if (is_array($roleOrPermission) && $this->grantAccessByRoles($roleOrPermission, $user)) {
            return true;
        } elseif (is_array($roleOrPermission) && $this->grantAccessByPermissions($roleOrPermission, $user)) {
            return true;
        } elseif ($this->grantAccessByRole($roleOrPermission, $user)) {
            return true;
        } elseif ($this->grantAccessByPermission($roleOrPermission, $user)) {
            return true;
        }
